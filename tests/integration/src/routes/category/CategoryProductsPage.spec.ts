...
const CATEGORY_PRODUCTS_PAGE_URL = '/category/ba22478d-2f6b-4a90-928d-1071ff7fbc23'

test.describe('Category products page breakpoints visual comparison', () => {
    test('should match screenshot for sm screen size', async ({page}) => {
        ...
        await page.goto(CATEGORY_PRODUCTS_PAGE_URL, {waitUntil: 'load'})
        await scroll(page)
