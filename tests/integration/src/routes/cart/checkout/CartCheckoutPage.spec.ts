...
const CART_CHECKOUT_PAGE_URL: string = '/cart/checkout'

test.describe('Cart checkout page breakpoints visual comparison', () => {
    test('should match screenshot for sm screen size', async ({page}) => {
        ...
        await page.goto(CART_CHECKOUT_PAGE_URL, {waitUntil: 'load'})
        await scroll(page)
